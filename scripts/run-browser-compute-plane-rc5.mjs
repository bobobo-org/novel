...
test("quality-gate", () => {
  ...
  const collapsedRepairFreshRecoveryInput = {
    initialContractSatisfied: false,
    initialSafetyCode: null,
    initialFailureCode: "minimum-length-unmet",
    initialRawBudgetExceeded: false,
    initialObservedHanCharacters: 58,
    initialFinishReason: "stop",
    ...
    repairFailureCode: "minimum-length-unmet",
    repairRawBudgetExceeded: false,
    repairObservedHanCharacters: 33,
    repairFinishReason: "stop",
  };
  assert.equal(
    isBrowserCollapsedRepairFreshRecoveryCandidate(
      collapsedRepairFreshRecoveryInput,
    ),
    true,
  );
  for (const [overrides, expected] of [
    ...
    [{ initialQualityReasonCodes: [] }, false],
    [{ initialQualityReasonCodes: ["QUALITY_NARRATIVE_TOO_SHORT"] }, false],
    [{ initialQualityReasonCodes: ["QUALITY_LENGTHCOMPLIANCE_LOW"] }, true],
  ]) {
    assert.equal(isBrowserCollapsedRepairFreshRecoveryCandidate({
      ...collapsedRepairFreshRecoveryInput,
      ...overrides,
    }), expected);
  }
  ...
  const degenerateInitialOversizedStopRepairInput = {
    initial: {
      contractSatisfied: false,
      safetyCode: null,
      failureCode: "minimum-length-unmet",
      rawBudgetExceeded: false,
      observedHanCharacters: 28,
      observedEstimatedTokens: 32,
      observedCodePoints: 31,
      selectedHanCharacters: 0,
      selectedEstimatedTokens: 0,
      selectedCodePoints: 0,
      ...
      runtimeTokenCap: 384,
      stageHardCap: 384,
      contentCharacters: 31,
      reportedOutputCharacters: 31,
      reportedRawOutputCharacters: 31,
      reportedNormalizedOutputCharacters: undefined,
      normalizationDeferred: true,
    },
    repair: {
      ...
      failureCode: "output-budget-exceeded",
      rawBudgetExceeded: true,
      observedHanCharacters: 508,
      observedEstimatedTokens: 572,
      observedCodePoints: 592,
      selectedHanCharacters: 0,
      selectedEstimatedTokens: 0,
      selectedCodePoints: 0,
      selectedContentAvailable: false,
      ...
      runtimeTokenCap: 360,
      stageHardCap: 360,
      contentCharacters: 592,
      reportedOutputCharacters: 592,
      reportedRawOutputCharacters: 592,
      reportedNormalizedOutputCharacters: undefined,
      normalizationDeferred: true,
    },
  };
  ...
  assert.equal(
    isBrowserUnderlengthInitialDenseOversizedStopRepairFreshRecoveryCandidate({
      ...
      repair: {
        ...degenerateInitialOversizedStopRepairInput.repair,
        reportedNormalizedOutputCharacters: 592,
        normalizationDeferred: false,
      },
    }),
    true,
  ...
  for (const initial of [
    {
      ...
      observedEstimatedTokens: 1,
      observedCodePoints: 1,
      completionTokens: 1,
      contentCharacters: 1,
      reportedOutputCharacters: 1,
      reportedRawOutputCharacters: 1,
    },
    {
      ...degenerateInitialOversizedStopRepairInput.initial,
  ...
  for (const repair of [
    ...
    {
      ...degenerateInitialOversizedStopRepairInput.repair,
      selectedHanCharacters: 240,
      selectedEstimatedTokens: 260,
      selectedCodePoints: 241,
      salvageableContentAvailable: true,
    },
  ]) {
    assert.equal(
      isBrowserUnderlengthInitialDenseOversizedStopRepairFreshRecoveryCandidate({
  ...
  for (const [stage, overrides] of [
    ["initial", { contractSatisfied: true }],
    ["initial", { safetyCode: "internal-envelope" }],
    ...
    ["initial", { selectedContentAvailable: true }],
    ...
    ["repair", { contractSatisfied: true }],
    ["repair", { safetyCode: "internal-envelope" }],
    ["repair", { failureCode: "minimum-length-unmet" }],
    ["repair", { rawBudgetExceeded: false }],
    ...
    ["repair", { selectedContentAvailable: true }],
    ["repair", { salvageableContentAvailable: true }],
    ["repair", {
      salvageableContentAvailable: true,
      selectedHanCharacters: 219,
      selectedEstimatedTokens: 240,
      selectedCodePoints: 220,
    }],
    ["repair", {
      salvageableContentAvailable: true,
      selectedHanCharacters: 321,
      selectedEstimatedTokens: 340,
      selectedCodePoints: 322,
    }],
    ["repair", {
      salvageableContentAvailable: true,
      selectedHanCharacters: 240,
    ...
    ["repair", {
      ...
      selectedHanCharacters: 240,
      selectedEstimatedTokens: 260,
      selectedCodePoints: 239,
    }],
    ["repair", {
      salvageableContentAvailable: true,
      selectedHanCharacters: 240,
      selectedEstimatedTokens: 260,
      selectedCodePoints: 641,
    }],
    ...
    assert.equal(
      ...
      false,
      `${stage}:${JSON.stringify(overrides)} must fail closed`,
    );
  }

  const nearTargetInitialNearCapOversizedRepairInput = {
    initial: {
      contractSatisfied: false,
      safetyCode: null,
      failureCode: "minimum-length-unmet",
      rawBudgetExceeded: false,
      observedHanCharacters: 217,
      observedEstimatedTokens: 242,
      observedCodePoints: 243,
      selectedHanCharacters: 0,
      selectedEstimatedTokens: 0,
      selectedCodePoints: 0,
      selectedContentAvailable: false,
      ...
      runtimeTokenCap: 384,
      stageHardCap: 384,
      contentCharacters: 243,
      reportedOutputCharacters: 243,
      reportedRawOutputCharacters: 243,
      reportedNormalizedOutputCharacters: undefined,
      normalizationDeferred: true,
    },
    repair: {
      ...
      failureCode: "output-budget-exceeded",
      rawBudgetExceeded: true,
      observedHanCharacters: 396,
      observedEstimatedTokens: 503,
      observedCodePoints: 667,
      selectedHanCharacters: 0,
      selectedEstimatedTokens: 0,
      selectedCodePoints: 0,
      selectedContentAvailable: false,
      ...
      runtimeTokenCap: 360,
      stageHardCap: 360,
      contentCharacters: 667,
      reportedOutputCharacters: 667,
      reportedRawOutputCharacters: 667,
      reportedNormalizedOutputCharacters: undefined,
      normalizationDeferred: true,
    },
  };
  assert.equal(
    isBrowserNearTargetInitialNearCapOversizedRepairFreshRecoveryCandidate(
      nearTargetInitialNearCapOversizedRepairInput,
    ),
    true,
  );
  assert.equal(
    isBrowserNearTargetInitialNearCapOversizedRepairFreshRecoveryCandidate({
      initial: {
        ...nearTargetInitialNearCapOversizedRepairInput.initial,
        reportedNormalizedOutputCharacters: 243,
        normalizationDeferred: false,
      },
      repair: {
        ...nearTargetInitialNearCapOversizedRepairInput.repair,
        reportedNormalizedOutputCharacters: 667,
        normalizationDeferred: false,
      },
    }),
    true,
  ...
  for (const initial of [
    {
      ...
      observedEstimatedTokens: 237,
      observedCodePoints: 238,
      contentCharacters: 238,
      reportedOutputCharacters: 238,
      reportedRawOutputCharacters: 238,
    },
    {
      ...nearTargetInitialNearCapOversizedRepairInput.initial,
      observedHanCharacters: 219,
      observedEstimatedTokens: 244,
      observedCodePoints: 245,
      contentCharacters: 245,
      reportedOutputCharacters: 245,
      reportedRawOutputCharacters: 245,
    },
  ]) {
    assert.equal(
      isBrowserNearTargetInitialNearCapOversizedRepairFreshRecoveryCandidate({
  ...
  for (const [stage, overrides] of [
    ...
    ["initial", { failureCode: null }],
    ["initial", { rawBudgetExceeded: true }],
    ["initial", { observedHanCharacters: 211 }],
    ["initial", { observedHanCharacters: 220 }],
    ["initial", { observedEstimatedTokens: 385 }],
    ["initial", { observedCodePoints: 216 }],
    ["initial", { observedCodePoints: 641 }],
    ["initial", { selectedHanCharacters: 1 }],
    ["initial", { selectedEstimatedTokens: 1 }],
    ["initial", { selectedCodePoints: 1 }],
    ["initial", { selectedContentAvailable: true }],
    ...
    ["initial", { finishReason: "length" }],
    ["initial", { completionTokens: 0 }],
    ["initial", { completionTokens: 143.5 }],
    ["initial", { runtimeTokenCap: 383 }],
    ["initial", { stageHardCap: 383 }],
    ["initial", { contentCharacters: 242 }],
    ["initial", { reportedOutputCharacters: 242 }],
    ["initial", { reportedRawOutputCharacters: 242 }],
    ["initial", { reportedNormalizedOutputCharacters: 243 }],
    ["repair", { contractSatisfied: true }],
    ["repair", { safetyCode: "internal-envelope" }],
    ["repair", { safetyCode: "credential" }],
    ["repair", { safetyCode: "role-envelope" }],
    ["repair", { safetyCode: "control-token" }],
    ["repair", { safetyCode: "raw-reasoning" }],
    ["repair", { failureCode: "minimum-length-unmet" }],
    ["repair", { rawBudgetExceeded: false }],
    ["repair", { observedHanCharacters: 320 }],
    ["repair", { observedHanCharacters: 417 }],
    ["repair", { observedEstimatedTokens: 384 }],
    ["repair", { observedEstimatedTokens: 513 }],
    ["repair", { observedCodePoints: 395 }],
    ["repair", { observedCodePoints: 705 }],
    ["repair", { selectedHanCharacters: 1 }],
    ["repair", { selectedEstimatedTokens: 1 }],
    ["repair", { selectedCodePoints: 1 }],
    ["repair", { selectedContentAvailable: true }],
    ["repair", { salvageableContentAvailable: true }],
    ["repair", { finishReason: "stop" }],
    ["repair", { finishReason: "abort" }],
    ["repair", { completionTokens: 351 }],
    ["repair", { completionTokens: 361 }],
    ["repair", { completionTokens: 359.5 }],
    ["repair", { runtimeTokenCap: 359 }],
    ["repair", { stageHardCap: 359 }],
    ["repair", { contentCharacters: 640 }],
    ["repair", { contentCharacters: 705 }],
    ["repair", { reportedOutputCharacters: 666 }],
    ["repair", { reportedRawOutputCharacters: 666 }],
    ["repair", { reportedNormalizedOutputCharacters: 667 }],
  ]) {
    assert.equal(
      isBrowserNearTargetInitialNearCapOversizedRepairFreshRecoveryCandidate({
        ...nearTargetInitialNearCapOversizedRepairInput,
        [stage]: {
          ...nearTargetInitialNearCapOversizedRepairInput[stage],
          ...overrides,
        },
      }),
      false,
  ...
  for (const repair of [
    {
      ...nearTargetInitialNearCapOversizedRepairInput.repair,
      observedHanCharacters: 321,
      observedEstimatedTokens: 436,
      observedCodePoints: 640,
    ...
    },
    {
      ...nearTargetInitialNearCapOversizedRepairInput.repair,
      observedHanCharacters: 321,
      observedEstimatedTokens: 454,
      observedCodePoints: 704,
      contentCharacters: 704,
      reportedOutputCharacters: 704,
      reportedRawOutputCharacters: 704,
    },
    {
      ...nearTargetInitialNearCapOversizedRepairInput.repair,
      observedHanCharacters: 416,
      observedEstimatedTokens: 512,
      observedCodePoints: 641,
      contentCharacters: 641,
      reportedOutputCharacters: 641,
      reportedRawOutputCharacters: 641,
  ...
  const repeatedOversizedStopFreshRecoveryInput = {
    initial: {
      contractSatisfied: false,
      safetyCode: null,
      failureCode: "output-budget-exceeded",
      rawBudgetExceeded: true,
      observedHanCharacters: 577,
      observedEstimatedTokens: 644,
      observedCodePoints: 651,
      finishReason: "stop",
      completionTokens: 368,
      runtimeTokenCap: 384,
      stageHardCap: 384,
      contentCharacters: 651,
      reportedOutputCharacters: 651,
      reportedRawOutputCharacters: 651,
      reportedNormalizedOutputCharacters: 651,
      normalizationDeferred: false,
    },
    repair: {
      contractSatisfied: false,
      ...
      failureCode: "output-budget-exceeded",
      rawBudgetExceeded: true,
      observedHanCharacters: 354,
      observedEstimatedTokens: 394,
      observedCodePoints: 395,
      finishReason: "stop",
      completionTokens: 232,
      runtimeTokenCap: 360,
      stageHardCap: 360,
      contentCharacters: 395,
      reportedOutputCharacters: 395,
      reportedRawOutputCharacters: 395,
      reportedNormalizedOutputCharacters: 395,
      normalizationDeferred: false,
    },
  };
  assert.equal(
    isBrowserRepeatedOversizedStopFreshRecoveryCandidate(
      repeatedOversizedStopFreshRecoveryInput,
    ),
    true,
  );
  assert.equal(
    isBrowserRepeatedOversizedStopFreshRecoveryCandidate({
      initial: {
        ...repeatedOversizedStopFreshRecoveryInput.initial,
        reportedNormalizedOutputCharacters: undefined,
        normalizationDeferred: true,
      },
      repair: {
        ...repeatedOversizedStopFreshRecoveryInput.repair,
        reportedNormalizedOutputCharacters: undefined,
        normalizationDeferred: true,
      },
    }),
  ...
  for (const [stage, overrides, expected] of [
    ["initial", { contractSatisfied: true }, false],
    ["initial", { safetyCode: "internal-envelope" }, false],
    ["initial", { failureCode: "minimum-length-unmet" }, false],
    ["initial", { rawBudgetExceeded: false }, false],
    ["initial", { observedHanCharacters: 320 }, false],
    ["initial", { finishReason: "length" }, false],
    ["initial", { completionTokens: 0 }, false],
    ["initial", { completionTokens: 385 }, false],
    ["initial", { runtimeTokenCap: 385 }, false],
    ["initial", { runtimeTokenCap: 384.9 }, false],
    ["initial", { stageHardCap: 383 }, false],
    ["initial", { observedCodePoints: 1_601 }, false],
    ["initial", { observedCodePoints: 576 }, false],
    ["initial", { observedEstimatedTokens: 705 }, false],
    ["initial", { contentCharacters: 650 }, false],
    ["initial", { contentCharacters: 1_303 }, false],
    ["initial", { reportedOutputCharacters: 650 }, false],
    ["initial", { reportedRawOutputCharacters: 650 }, false],
    ["initial", { reportedNormalizedOutputCharacters: undefined }, false],
    ["initial", {
      reportedNormalizedOutputCharacters: 651,
      normalizationDeferred: true,
    }, false],
    ["repair", { contractSatisfied: true }, false],
    ["repair", { safetyCode: "role-envelope" }, false],
    ["repair", { failureCode: "complete-sentence-unavailable" }, false],
    ["repair", { rawBudgetExceeded: false }, false],
    ["repair", { observedHanCharacters: 320 }, false],
    ["repair", {
      observedEstimatedTokens: 384,
      ...
      reportedOutputCharacters: 640,
      reportedRawOutputCharacters: 640,
      reportedNormalizedOutputCharacters: 640,
    }, false],
    ["repair", {
      observedEstimatedTokens: 385,
      observedCodePoints: 640,
    ...
    ["repair", {
      ...
      reportedOutputCharacters: 641,
      reportedRawOutputCharacters: 641,
      reportedNormalizedOutputCharacters: 641,
    }, true],
    ["repair", { finishReason: "length" }, false],
    ["repair", { completionTokens: null }, false],
    ["repair", { completionTokens: 361 }, false],
    ["repair", { runtimeTokenCap: 361 }, false],
    ["repair", { runtimeTokenCap: 360.9 }, false],
    ["repair", { stageHardCap: 359 }, false],
    ["repair", { observedCodePoints: 1_057 }, false],
    ["repair", { observedCodePoints: 353 }, false],
    ["repair", { observedEstimatedTokens: 428 }, false],
    ["repair", { contentCharacters: 394 }, false],
    ["repair", { contentCharacters: 791 }, false],
    ["repair", { reportedOutputCharacters: 394 }, false],
    ["repair", { reportedRawOutputCharacters: 394 }, false],
    ["repair", { reportedNormalizedOutputCharacters: undefined }, false],
    ["repair", {
      reportedNormalizedOutputCharacters: 395,
      normalizationDeferred: true,
    }, false],
    ...
    assert.equal(
      isBrowserRepeatedOversizedStopFreshRecoveryCandidate({
        ...repeatedOversizedStopFreshRecoveryInput,
        [stage]: {
          ...repeatedOversizedStopFreshRecoveryInput[stage],
          ...overrides,
        },
      }),
      expected,
  ...
  const oversizedInitialCollapsedRepairFreshRecoveryInput = {
    initialContractSatisfied: false,
    initialSafetyCode: null,
    initialFailureCode: "output-budget-exceeded",
    initialRawBudgetExceeded: true,
    initialObservedHanCharacters: 555,
    initialObservedEstimatedTokens: 626,
    initialObservedCodePoints: 648,
    initialFinishReason: "stop",
    initialCompletionTokens: 375,
    initialRuntimeTokenCap: 384,
    initialStageHardCap: 384,
    initialContentCharacters: 648,
    initialReportedRawOutputCharacters: 648,
    initialReportedNormalizedOutputCharacters: 648,
    repairContractSatisfied: false,
    repairSafetyCode: null,
    repairFailureCode: "minimum-length-unmet",
    repairRawBudgetExceeded: false,
    repairObservedHanCharacters: 41,
    repairObservedEstimatedTokens: 46,
    repairObservedCodePoints: 45,
    repairFinishReason: "stop",
    repairCompletionTokens: 28,
    repairRuntimeTokenCap: 360,
    repairStageHardCap: 360,
    repairContentCharacters: 45,
    repairReportedRawOutputCharacters: 45,
    repairReportedNormalizedOutputCharacters: 45,
  };
  assert.equal(
    isBrowserOversizedInitialCollapsedRepairFreshRecoveryCandidate(
      oversizedInitialCollapsedRepairFreshRecoveryInput,
    ),
    true,
  );
  for (const [overrides, expected] of [
    [{
      initialObservedHanCharacters: 329,
      initialObservedEstimatedTokens: 414,
      initialObservedCodePoints: 539,
      initialCompletionTokens: 243,
      initialContentCharacters: 539,
      initialReportedRawOutputCharacters: 539,
      initialReportedNormalizedOutputCharacters: 539,
    }, true],
    [{ initialContractSatisfied: true }, false],
    [{ initialSafetyCode: "internal-envelope" }, false],
    [{ initialFailureCode: "minimum-length-unmet" }, false],
    [{ initialRawBudgetExceeded: false }, false],
    [{ initialObservedHanCharacters: 320 }, false],
    [{ initialFinishReason: "length" }, false],
    [{ initialCompletionTokens: 0 }, false],
    [{ initialRuntimeTokenCap: 385 }, false],
    [{ initialStageHardCap: 383 }, false],
    [{ initialContentCharacters: 647 }, false],
    [{ initialContentCharacters: 1_297 }, false],
    [{ initialReportedRawOutputCharacters: 647 }, false],
    [{ initialReportedNormalizedOutputCharacters: null }, false],
    [{ repairContractSatisfied: true }, false],
    [{ repairSafetyCode: "role-envelope" }, false],
    [{ repairFailureCode: "complete-sentence-unavailable" }, false],
    [{ repairRawBudgetExceeded: true }, false],
    [{ repairObservedHanCharacters: 0 }, false],
    [{ repairObservedHanCharacters: 1 }, true],
    [{
      repairObservedHanCharacters: 47,
      repairObservedCodePoints: 47,
      repairContentCharacters: 47,
      repairReportedRawOutputCharacters: 47,
      repairReportedNormalizedOutputCharacters: 47,
    }, true],
    [{ repairObservedHanCharacters: 48 }, false],
    [{ repairFinishReason: "length" }, false],
    [{ repairCompletionTokens: 0 }, false],
    ...
    [{ repairStageHardCap: 359 }, false],
    [{ repairObservedEstimatedTokens: 361 }, false],
    [{ repairObservedCodePoints: 241 }, false],
    [{ repairContentCharacters: 44 }, false],
    [{ repairContentCharacters: 91 }, false],
    [{ repairReportedRawOutputCharacters: 44 }, false],
    [{ repairReportedNormalizedOutputCharacters: null }, false],
  ]) {
    assert.equal(
      isBrowserOversizedInitialCollapsedRepairFreshRecoveryCandidate({
...
test("bounded-prose-extension", async () => {
  ...
  const execute = async (
    initialResult,
    queuedResults,
    executionRequestOverride = request,
    deferTraditionalChineseNormalization = false,
  ) => {
    const calls = [];
  ...
  // Match the Fresh Edge failure topology without retaining its prose: a
  // severely undersized 58-Han initial pass followed by a collapsed 33-Han
  // repair. Spend the third and final inference on a standalone fresh draft,
  // never on a suffix whose rejected base is too weak for reliable recovery.
  const collapsedInitialSentinel = "她便扯下鐘繩";
  const collapsedRepairSentinel = "水道盡頭亮起";
  const exactHanText = (source, target) => {
    const value = Array.from(source)
      .filter((character) => /\p{Script=Han}/u.test(character))
      .slice(0, target)
      .join("");
    assert.equal(countBrowserProseHanCharacters(value), target);
    return value;
  };
  const collapsedInitial58 = `${exactHanText(suffixParts[0], 19)}。${
    exactHanText(suffixParts[1], 19)
  }。\n${exactHanText(suffixParts[2], 20)}。`;
  const collapsedRepair33 = `${exactHanText(suffixParts[3], 16)}。\n${
    exactHanText(suffixParts[4], 17)
  }。`;
  const collapsedRecovery240 = exactHanPrefix(acceptedProse.repeat(3), 240);
  const collapsedInitialQuality = evaluateBrowserCandidateQuality({
    taskType: request.taskType,
    content: collapsedInitial58,
    expectedMinTokens: 140,
    expectedMaxTokens: performancePolicy.reservedOutputTokens,
    approvedContext: request.context,
    threshold: 0.7,
  });
  assert.equal(countBrowserProseHanCharacters(collapsedInitial58), 58);
  assert.equal(Array.from(collapsedInitial58).length, 62);
  ...
  assert.equal(
    assessBrowserProseCompletion(collapsedInitial58).failureCode,
    "minimum-length-unmet",
  );
  assert.equal(
    assessBrowserProseCompletion(collapsedRepair33).failureCode,
    "minimum-length-unmet",
  );
  const collapsedRepairRecovery = await execute({
    ...result(collapsedInitial58, "stop"),
    completionTokens: 43,
    rawOutputCharacters: 62,
    normalizedOutputCharacters: 62,
  }, [
    {
      ...result(
        collapsedRepair33,
      ...
      completionTokens: 21,
      rawOutputCharacters: 36,
      normalizedOutputCharacters: 36,
    },
    (recoveryRequest, options) => {
      ...
      assert.doesNotMatch(
        ...
        new RegExp(`${collapsedInitialSentinel}|${collapsedRepairSentinel}`, "u"),
      );
      return {
        ...result(
  ...
  assert.equal(collapsedRepairRecovery.calls.length, 2);
  assert.deepEqual(
    collapsedRepairRecovery.calls.map((call) => call.request.requestId),
    [
      `${request.requestId}:bounded-same-model-repair`,
      `${request.requestId}:bounded-fresh-recovery`,
    ],
  ...
  assert.deepEqual(
    collapsedRepairRecovery.browserRuntimeEvidence.map((entry) => [
      entry.stage,
      entry.finishReason,
    ...
    [
      ["initial", "stop", 43, 62, 62, 58],
      ["repair", "stop", 21, 36, 36, 33],
      [
        "recovery",
        "stop",
        252,
  ...
  assert.equal(collapsedRepairRecovery.result.content, collapsedRecovery240);
  assert.equal(collapsedRepairRecovery.quality.decision, "pass");
  assert.equal(
    assessBrowserProseCompletion(collapsedRepairRecovery.result.content)
      .contractSatisfied,
    true,
  );
  assert.match(
    collapsedRepairRecovery.result.runtimeStats,
  ...
  assert.doesNotMatch(
    JSON.stringify(collapsedRepairRecovery),
    new RegExp(`${collapsedInitialSentinel}|${collapsedRepairSentinel}`, "u"),
  );
  const collapsedRecovery134 = exactHanPrefix(acceptedProse.repeat(2), 134);
  let collapsedFailureCalls = 0;
  await assert.rejects(
    () => executeBrowserBoundedQualityPasses({
      request,
      decision,
      ...
      runPass: async (passRequest) => {
        collapsedFailureCalls += 1;
        if (collapsedFailureCalls === 1) {
          assert.equal(
        ...
        assert.equal(collapsedFailureCalls, 2, "fresh recovery must be the final pass");
        assert.equal(
          passRequest.requestId,
          `${request.requestId}:bounded-fresh-recovery`,
        );
    ...
    (error) => {
      ...
      return error.code === "BROWSER_AI_QUALITY_INSUFFICIENT"
        ...
        && evidence.length === 3
        && evidence[0]?.stage === "initial"
        && evidence[0]?.observedHanCharacters === 58
        && evidence[1]?.stage === "repair"
        && evidence[1]?.observedHanCharacters === 33
        && evidence[2]?.stage === "recovery"
        && evidence[2]?.observedHanCharacters === 134
        && !new RegExp(
          `${collapsedInitialSentinel}|${collapsedRepairSentinel}`,
          "u",
  ...
  // Match the latest Fresh Edge failure topology exactly: the initial draft
  // stopped normally but exceeded the raw budget, its isolated repair
  // collapsed to 41 Han characters, and the third/final pass must therefore
  // be a standalone fresh draft. Neither rejected draft may become a prefix,
  // continuation seed, digest, or model input.
  const collapsedOversizedInitialSentinel = "initialoversizedmark";
  const collapsedOversizedInitialBase = `${"風".repeat(329)}。${collapsedOversizedInitialSentinel}`;
  assert.ok(collapsedOversizedInitialBase.length <= 539);
  const collapsedOversizedInitial329 = `${collapsedOversizedInitialBase}${"a".repeat(
    539 - collapsedOversizedInitialBase.length,
  )}`;
  const collapsedOversizedRepairSentinel = "r9x";
  const collapsedOversizedRepair41 = `${"風".repeat(41)}。${collapsedOversizedRepairSentinel}`;
  const collapsedOversizedInitialCompletion = assessBrowserProseCompletion(
    collapsedOversizedInitial329,
  );
  const collapsedOversizedRepairCompletion = assessBrowserProseCompletion(
    collapsedOversizedRepair41,
  );
  assert.equal(collapsedOversizedInitial329.length, 539);
  assert.equal(Array.from(collapsedOversizedInitial329).length, 539);
  assert.equal(collapsedOversizedInitialCompletion.observedHanCharacters, 329);
  assert.equal(collapsedOversizedInitialCompletion.observedEstimatedTokens, 414);
  assert.equal(collapsedOversizedInitialCompletion.failureCode, "output-budget-exceeded");
  assert.equal(collapsedOversizedInitialCompletion.rawBudgetExceeded, true);
  assert.equal(collapsedOversizedRepair41.length, 45);
  assert.equal(Array.from(collapsedOversizedRepair41).length, 45);
  assert.equal(collapsedOversizedRepairCompletion.observedHanCharacters, 41);
  assert.equal(collapsedOversizedRepairCompletion.observedEstimatedTokens, 46);
  assert.equal(collapsedOversizedRepairCompletion.failureCode, "minimum-length-unmet");
  assert.equal(collapsedOversizedRepairCompletion.rawBudgetExceeded, false);
  const collapsedOversizedInitialRecovery = await execute({
    ...result(collapsedOversizedInitial329, "stop"),
    completionTokens: 243,
    rawOutputCharacters: 539,
    normalizedOutputCharacters: 539,
  }, [
    (repairRequest, options) => {
      assert.equal(
      ...
      assert.doesNotMatch(
        JSON.stringify({ repairRequest, options }),
        new RegExp(collapsedOversizedInitialSentinel, "u"),
      );
      return {
        ...result(
          collapsedOversizedRepair41,
        ...
        completionTokens: 28,
        rawOutputCharacters: 45,
        normalizedOutputCharacters: 45,
      };
    },
    (recoveryRequest, options) => {
      assert.equal(
      ...
      assert.doesNotMatch(
        JSON.stringify({ recoveryRequest, options }),
        new RegExp(
          `${collapsedOversizedInitialSentinel}|${collapsedOversizedRepairSentinel}`,
          "u",
        ),
      );
      return {
  ...
  assert.deepEqual(
    collapsedOversizedInitialRecovery.calls.map((call) => call.request.requestId),
    [
      `${request.requestId}:bounded-same-model-repair`,
      `${request.requestId}:bounded-fresh-recovery`,
    ],
  ...
  assert.deepEqual(
    collapsedOversizedInitialRecovery.browserRuntimeEvidence.map((entry) => [
      entry.stage,
      entry.finishReason,
      entry.completionTokens,
      entry.rawOutputCharacters,
    ...
    [
      ["initial", "stop", 243, 539, 539, 329],
      ["repair", "stop", 28, 45, 45, 41],
      [
        "recovery",
        "stop",
        252,
  ...
  assert.equal(collapsedOversizedInitialRecovery.result.content, exactTraceRecovery240);
  assert.equal(collapsedOversizedInitialRecovery.quality.decision, "pass");
  assert.equal(collapsedOversizedInitialRecovery.result.externalRequest, false);
  assert.equal(collapsedOversizedInitialRecovery.result.dataLeavesDevice, false);
  assert.match(
    collapsedOversizedInitialRecovery.result.runtimeStats,
  ...
  assert.match(
    collapsedOversizedInitialRecovery.result.provenance.warnings.join(" "),
    /one fresh recovery draft ran on the same verified Browser executor/iu,
  );
  assert.doesNotMatch(
    JSON.stringify(collapsedOversizedInitialRecovery),
    new RegExp(
      `${collapsedOversizedInitialSentinel}|${collapsedOversizedRepairSentinel}`,
      "u",
    ),
  );
  const collapsedOversizedRecovery134 = exactHanPrefix(acceptedProse.repeat(2), 134);
  let collapsedOversizedFailureCalls = 0;
  await assert.rejects(
    () => executeBrowserBoundedQualityPasses({
      request,
      decision,
      ...
      requiredGenerativeExecutor: "webllm-worker",
      runPass: async () => {
        collapsedOversizedFailureCalls += 1;
        assert.ok(
          collapsedOversizedFailureCalls <= 2,
          "collapsed oversized recovery failure must not run a fourth pass",
        );
        if (collapsedOversizedFailureCalls === 1) {
          return {
            ...result(
              collapsedOversizedRepair41,
              "stop",
        ...
        return {
          ...result(
            collapsedOversizedRecovery134,
            "stop",
            `${request.requestId}:bounded-fresh-recovery`,
          ),
          completionTokens: 96,
          rawOutputCharacters: collapsedOversizedRecovery134.length,
          normalizedOutputCharacters: collapsedOversizedRecovery134.length,
        };
      },
    }),
    (error) => {
      ...
      return error.code === "BROWSER_AI_QUALITY_INSUFFICIENT"
        ...
        && evidence.length === 3
        && evidence[0]?.stage === "initial"
        && evidence[0]?.observedHanCharacters === 329
        && evidence[1]?.stage === "repair"
        && evidence[1]?.observedHanCharacters === 41
        && evidence[2]?.stage === "recovery"
        && evidence[2]?.observedHanCharacters === 134
        && error.fallbackAttempted === false
        && error.canonicalMutationCount === 0
  ...
  assert.equal(collapsedOversizedFailureCalls, 2);
  ...
  // The recovery authorization composes existing oversized-stop truth; it
  // must not reintroduce an arbitrary Han ceiling. A larger 555-Han rejected
  // initial followed by the same collapsed repair is therefore eligible for
  // the same single third/final standalone recovery.
  const largeOversizedCollapsedRecovery = await execute({
    ...result(oversizedStopRaw, "stop"),
    completionTokens: 375,
    rawOutputCharacters: 648,
    normalizedOutputCharacters: 648,
    ...
    (recoveryRequest, options) => {
      ...
      assert.doesNotMatch(
        JSON.stringify({ recoveryRequest, options }),
        new RegExp(
          `${oversizedStopSentinel}|${collapsedOversizedRepairSentinel}`,
          "u",
        ),
      );
      return {
  ...
  assert.deepEqual(
    largeOversizedCollapsedRecovery.calls.map((call) => call.request.requestId),
    [
      `${request.requestId}:bounded-same-model-repair`,
      `${request.requestId}:bounded-fresh-recovery`,
    ],
  ...
  assert.deepEqual(
    largeOversizedCollapsedRecovery.browserRuntimeEvidence.map((entry) => [
      entry.stage,
      entry.observedHanCharacters,
    ]),
    [
  ...
  assert.equal(largeOversizedCollapsedRecovery.result.content, exactTraceRecovery240);
  assert.equal(largeOversizedCollapsedRecovery.quality.decision, "pass");
  assert.match(
    largeOversizedCollapsedRecovery.result.runtimeStats,
    /bounded-prose-extension=0/u,
  );
  assert.match(
    largeOversizedCollapsedRecovery.result.runtimeStats,
  ...
  assert.doesNotMatch(
    JSON.stringify(largeOversizedCollapsedRecovery),
    new RegExp(
      `${oversizedStopSentinel}|${collapsedOversizedRepairSentinel}`,
      "u",
    ),
  ...
  const repeatedOversizedSafePrefix = `${"\u98a8".repeat(240)}\u3002`;
  assert.equal(
    assessBrowserProseCompletion(repeatedOversizedSafePrefix).contractSatisfied,
    true,
  );
  const repeatedOversizedInitialSentinel = "INITIAL_577_REJECTED_X9";
  const repeatedOversizedInitialBase = `${repeatedOversizedSafePrefix}${"\u98a8".repeat(
    337,
  )}${repeatedOversizedInitialSentinel}`;
  assert.ok(repeatedOversizedInitialBase.length <= 651);
  const repeatedOversizedInitial577 = `${repeatedOversizedInitialBase}${"A".repeat(
    651 - repeatedOversizedInitialBase.length,
  )}`;
  const repeatedOversizedRepairSentinel = "REPAIR_354_REJECTED_X9";
  const repeatedOversizedRepairBase = `${repeatedOversizedSafePrefix}${"\u98a8".repeat(
    114,
  )}${repeatedOversizedRepairSentinel}`;
  assert.ok(repeatedOversizedRepairBase.length <= 395);
  const repeatedOversizedRepair354 = `${repeatedOversizedRepairBase}${"B".repeat(
    395 - repeatedOversizedRepairBase.length,
  )}`;
  const repeatedOversizedInitialCompletion = assessBrowserProseCompletion(
    repeatedOversizedInitial577,
  );
  const repeatedOversizedRepairCompletion = assessBrowserProseCompletion(
    repeatedOversizedRepair354,
  );
  assert.deepEqual({
    length: repeatedOversizedInitial577.length,
    codePoints: Array.from(repeatedOversizedInitial577).length,
    han: repeatedOversizedInitialCompletion.observedHanCharacters,
    estimatedTokens:
      repeatedOversizedInitialCompletion.observedEstimatedTokens,
    failureCode: repeatedOversizedInitialCompletion.failureCode,
    rawBudgetExceeded:
      repeatedOversizedInitialCompletion.rawBudgetExceeded,
    selectedHan: repeatedOversizedInitialCompletion.selectedHanCharacters,
  }, {
    length: 651,
    codePoints: 651,
    han: 577,
  ...
  assert.deepEqual({
    length: repeatedOversizedRepair354.length,
    codePoints: Array.from(repeatedOversizedRepair354).length,
    han: repeatedOversizedRepairCompletion.observedHanCharacters,
    estimatedTokens: repeatedOversizedRepairCompletion.observedEstimatedTokens,
    failureCode: repeatedOversizedRepairCompletion.failureCode,
    rawBudgetExceeded: repeatedOversizedRepairCompletion.rawBudgetExceeded,
    selectedHan: repeatedOversizedRepairCompletion.selectedHanCharacters,
  }, {
    length: 395,
    codePoints: 395,
    han: 354,
  ...
  const repeatedOversizedStopRecovery = await execute({
    ...deferredResult(repeatedOversizedInitial577, "stop"),
    completionTokens: 368,
    rawOutputCharacters: 651,
  }, [
    (repairRequest, options) => {
      assert.equal(
        repairRequest.requestId,
      ...
      assert.doesNotMatch(
        JSON.stringify({ repairRequest, options }),
        new RegExp(repeatedOversizedInitialSentinel, "u"),
      );
      return {
        ...deferredResult(
          repeatedOversizedRepair354,
    ...
    (recoveryRequest, options) => {
      ...
      assert.doesNotMatch(
        JSON.stringify({ recoveryRequest, options }),
        new RegExp(
          `${repeatedOversizedInitialSentinel}|${repeatedOversizedRepairSentinel}`,
          "u",
        ),
      );
      return {
  ...
  assert.deepEqual(
    repeatedOversizedStopRecovery.calls.map((call) => call.request.requestId),
    [
      `${request.requestId}:bounded-same-model-repair`,
      `${request.requestId}:bounded-fresh-recovery`,
    ],
  ...
  assert.deepEqual(
    repeatedOversizedStopRecovery.browserRuntimeEvidence.map((entry) => [
      entry.stage,
      entry.finishReason,
      entry.completionTokens,
      entry.rawOutputCharacters,
    ...
    [
      ["initial", "stop", 368, 651, 651, 577],
      ["repair", "stop", 232, 395, 395, 354],
      [
        "recovery",
        "stop",
        252,
  ...
  assert.equal(repeatedOversizedStopRecovery.result.content, exactTraceRecovery240);
  assert.equal(repeatedOversizedStopRecovery.result.normalizedOutputCharacters, undefined);
  assert.equal(repeatedOversizedStopRecovery.quality.decision, "pass");
  assert.equal(repeatedOversizedStopRecovery.result.externalRequest, false);
  assert.equal(repeatedOversizedStopRecovery.result.dataLeavesDevice, false);
  assert.match(
    repeatedOversizedStopRecovery.result.runtimeStats,
    /bounded-prose-extension=0/u,
  );
  assert.match(
    repeatedOversizedStopRecovery.result.runtimeStats,
  ...
  assert.doesNotMatch(
    JSON.stringify(repeatedOversizedStopRecovery),
    new RegExp(
      `${repeatedOversizedInitialSentinel}|${repeatedOversizedRepairSentinel}`,
      "u",
    ),
  );
  const repeatedOversizedRecovery134 = exactHanPrefix(
    acceptedProse.repeat(2),
    134,
  );
  let repeatedOversizedFailureCalls = 0;
  await assert.rejects(
    () => executeBrowserBoundedQualityPasses({
      request,
      decision,
      ...
      deferTraditionalChineseNormalization: true,
      runPass: async () => {
        repeatedOversizedFailureCalls += 1;
        assert.ok(
          repeatedOversizedFailureCalls <= 2,
          "repeated oversized recovery failure must not run a fourth pass",
        );
        if (repeatedOversizedFailureCalls === 1) {
          return {
            ...deferredResult(
              repeatedOversizedRepair354,
              "stop",
        ...
        return {
          ...deferredResult(
            repeatedOversizedRecovery134,
            "stop",
            `${request.requestId}:bounded-fresh-recovery`,
          ),
          completionTokens: 143,
          rawOutputCharacters: repeatedOversizedRecovery134.length,
        };
      },
    }),
    (error) => error.code === "BROWSER_AI_QUALITY_INSUFFICIENT"
      && error.qualityReasonCodes.includes("QUALITY_NARRATIVE_TOO_SHORT")
      && error.browserRuntimeEvidence?.length === 3
      && !new RegExp(
        `${repeatedOversizedInitialSentinel}|${repeatedOversizedRepairSentinel}`,
        "u",
      ).test(JSON.stringify(error)),
  );
  assert.equal(repeatedOversizedFailureCalls, 2);
  ...
  for (const invalidRepair of [
    ...
    },
    {
      ...
      finishReason: "stop",
      completionTokens: 359,
      resultOverrides: { normalizedOutputCharacters: 647 },
      expectedCode: "BROWSER_AI_QUALITY_INSUFFICIENT",
      expectedReasonCode: "QUALITY_OUTPUT_TRUNCATED",
    },
    {
  ...
  await assertAuthoritativeSelectedResult({
    ...
    discardedSentinel:
      `${collapsedOversizedInitialSentinel}|${collapsedOversizedRepairSentinel}`,
    taskId: "browser-oversized-initial-collapsed-repair-fresh-recovery-candidate",
  });
  await assertAuthoritativeSelectedResult({
    selectedExecution: repeatedOversizedStopRecovery,
    rawGeneration:
      `${repeatedOversizedInitial577}\n${repeatedOversizedRepair354}`,
    discardedSentinel:
      `${repeatedOversizedInitialSentinel}|${repeatedOversizedRepairSentinel}`,
    taskId: "browser-repeated-oversized-stop-fresh-recovery-candidate",
  });
  await assertAuthoritativeSelectedResult({
  ...
  // Match the safe 65e Fresh trace with constructed finite evidence only: a
  // 217-Han normal-EOS initial draft and a 396-Han near-cap length repair with
  // 667 UTF-16 characters and no verified bounded prefix. Both are discarded
  // before one final standalone, attested grammar recovery.
  const nearTargetInitialSentinel = "I217SAFE_X9";
  const nearTargetRepairSentinel = "R396OVERSIZED_X9";
  const nearTargetInitialBase = `${uniqueHan(217, 0x6000)}${nearTargetInitialSentinel}`;
  assert.ok(nearTargetInitialBase.length <= 243);
  const nearTargetInitial217 = `${nearTargetInitialBase}${"I".repeat(
    243 - nearTargetInitialBase.length,
  )}`;
  const nearTargetRepairBase = `${uniqueHan(396, 0x6800)}${nearTargetRepairSentinel}`;
  assert.ok(nearTargetRepairBase.length <= 667);
  const nearTargetRepair396 = `${nearTargetRepairBase}${"R".repeat(
    667 - nearTargetRepairBase.length,
  )}`;
  const nearTargetInitialAssessment = assessBrowserProseCompletion(
    nearTargetInitial217,
  );
  const nearTargetRepairAssessment = assessBrowserProseCompletion(
    nearTargetRepair396,
  );
  assert.deepEqual({
    characters: nearTargetInitial217.length,
    han: nearTargetInitialAssessment.observedHanCharacters,
    estimatedTokens: nearTargetInitialAssessment.observedEstimatedTokens,
    codePoints: nearTargetInitialAssessment.observedCodePoints,
    failureCode: nearTargetInitialAssessment.failureCode,
    rawBudgetExceeded: nearTargetInitialAssessment.rawBudgetExceeded,
    selectedHanCharacters: nearTargetInitialAssessment.selectedHanCharacters,
    content: nearTargetInitialAssessment.content,
    salvageableContent: nearTargetInitialAssessment.salvageableContent,
  }, {
    characters: 243,
    han: 217,
    estimatedTokens: 242,
  ...
  assert.deepEqual({
    characters: nearTargetRepair396.length,
    han: nearTargetRepairAssessment.observedHanCharacters,
    estimatedTokens: nearTargetRepairAssessment.observedEstimatedTokens,
    codePoints: nearTargetRepairAssessment.observedCodePoints,
    failureCode: nearTargetRepairAssessment.failureCode,
    rawBudgetExceeded: nearTargetRepairAssessment.rawBudgetExceeded,
    selectedHanCharacters: nearTargetRepairAssessment.selectedHanCharacters,
    content: nearTargetRepairAssessment.content,
    salvageableContent: nearTargetRepairAssessment.salvageableContent,
  }, {
    characters: 667,
    han: 396,
    estimatedTokens: 503,
  ...
  const nearTargetOuterRequestId = "browser-near-target-oversized-repair-outer";
  const nearTargetAttestedRequest = {
    ...request,
    contextAttestation: "required",
    browserFinalContextOuterRequestId: nearTargetOuterRequestId,
    browserFinalContextOuterTaskType: request.taskType,
    browserFinalContextOuterQualityPhase: "draft",
    browserFinalContextExpectations: [],
  };
  const nearTargetInvocationProof = async (
    invocationRequestId,
    innerStage,
    innerIndex,
  ) => createBrowserFinalModelContextInvocationProof({
    outerRequestId: nearTargetOuterRequestId,
    invocationRequestId,
    outerTaskType: request.taskType,
    outerQualityPhase: "draft",
    innerStage,
    ...
    modelDigest: model.modelDigest,
    callOptionsDigest: await sha256Hex(
      `near-target-oversized-repair:${innerStage}:${innerIndex}`,
    ),
    systemMessage: "bounded recovery proof system descriptor",
    userMessage: "bounded recovery proof user descriptor",
    expectations: [],
  ...
  const nearTargetRejectedDigests = [
    await sha256Hex(nearTargetInitial217),
    await sha256Hex(nearTargetRepair396),
  ];
  const nearTargetInitialResult = {
    ...result(nearTargetInitial217, "stop"),
    completionTokens: 143,
    rawOutputCharacters: 243,
    normalizedOutputCharacters: undefined,
    browserModelContextInvocationProof:
      await nearTargetInvocationProof(request.requestId, "initial", 0),
  };
  const nearTargetRepairResult = {
    ...result(
      nearTargetRepair396,
      "length",
      `${request.requestId}:bounded-same-model-repair`,
    ...
    completionTokens: 359,
    rawOutputCharacters: 667,
    normalizedOutputCharacters: undefined,
    browserModelContextInvocationProof:
      await nearTargetInvocationProof(
        `${request.requestId}:bounded-same-model-repair`,
        "repair",
        1,
      ),
  };
  const nearTargetOversizedRepairRecovery = await execute(
    nearTargetInitialResult,
    [
      nearTargetRepairResult,
      async (recoveryRequest, options) => {
        assertBoundedFreshRecoveryRequest(recoveryRequest, options);
        assert.equal(
          recoveryRequest.input,
        ...
        assert.deepEqual(recoveryRequest.context, nearTargetAttestedRequest.context);
        assert.equal(options.unapprovedContinuationSeed, undefined);
        const serializedRecoveryInput = JSON.stringify({ recoveryRequest, options });
        for (const rejectedValue of [
          nearTargetInitial217,
          nearTargetRepair396,
          nearTargetInitialSentinel,
          nearTargetRepairSentinel,
          ...nearTargetRejectedDigests,
        ]) {
    ...
    nearTargetAttestedRequest,
    true,
  );
  assert.deepEqual(
    nearTargetOversizedRepairRecovery.calls.map((call) => call.request.requestId),
    [
      `${request.requestId}:bounded-same-model-repair`,
      `${request.requestId}:bounded-fresh-recovery`,
    ],
  ...
  assert.deepEqual(
    nearTargetOversizedRepairRecovery.browserRuntimeEvidence.map((entry) => [
      entry.stage,
      entry.finishReason,
      entry.completionTokens,
      entry.rawOutputCharacters,
    ...
    [
      ["initial", "stop", 143, 243, 217],
      ["repair", "length", 359, 667, 396],
      ["recovery", "stop", 252, exactTraceRecovery240.length, 240],
    ],
  );
  assert.equal(nearTargetOversizedRepairRecovery.result.content, exactTraceRecovery240);
  assert.equal(nearTargetOversizedRepairRecovery.quality.decision, "pass");
  assert.equal(nearTargetOversizedRepairRecovery.result.externalRequest, false);
  assert.equal(nearTargetOversizedRepairRecovery.result.dataLeavesDevice, false);
  assert.ok(
    await verifyBrowserFinalModelContextAttestation(
      nearTargetOversizedRepairRecovery.result.finalModelContextAttestation,
    ),
  );
  assert.equal(
    nearTargetOversizedRepairRecovery.result
      .finalModelContextAttestation.acceptedDisposition,
    "standalone",
  );
  assert.equal(
    nearTargetOversizedRepairRecovery.result.finalModelContextAttestation.acceptedStage,
    "recovery",
  );
  assert.deepEqual(
    nearTargetOversizedRepairRecovery.result
  ...
  assert.match(
    nearTargetOversizedRepairRecovery.result.runtimeStats,
    /bounded-prose-extension=0/u,
  );
  assert.match(
    nearTargetOversizedRepairRecovery.result.runtimeStats,
  ...
  const serializedNearTargetRecovery = JSON.stringify(
    nearTargetOversizedRepairRecovery,
  );
  for (const rejectedValue of [
    nearTargetInitial217,
    nearTargetRepair396,
    ...
    assert.equal(serializedNearTargetRecovery.includes(rejectedValue), false);
  }
  await assertAuthoritativeSelectedResult({
    selectedExecution: nearTargetOversizedRepairRecovery,
    rawGeneration: `${nearTargetInitial217}\n${nearTargetRepair396}`,
    rejectedGenerations: [nearTargetInitial217, nearTargetRepair396],
    discardedSentinel: `${nearTargetInitialSentinel}|${nearTargetRepairSentinel}`,
    taskId: "browser-near-target-oversized-repair-recovery-candidate",
  });

  const nearTargetSalvageBase = `${exactTraceRecovery240}${uniqueHan(156, 0x7000)}${
    nearTargetRepairSentinel
  }`;
  assert.ok(nearTargetSalvageBase.length <= 667);
  const nearTargetSalvageRepair = `${nearTargetSalvageBase}${"S".repeat(
    667 - nearTargetSalvageBase.length,
  )}`;
  const nearTargetSalvageAssessment = assessBrowserProseCompletion(
    nearTargetSalvageRepair,
  );
  assert.equal(nearTargetSalvageAssessment.observedHanCharacters, 396);
  assert.equal(nearTargetSalvageAssessment.rawBudgetExceeded, true);
  assert.equal(
    nearTargetSalvageAssessment.salvageableContent,
    exactTraceRecovery240,
  );
  const nearTargetSalvagedRepair = await execute(
    nearTargetInitialResult,
    [{
      ...result(
        nearTargetSalvageRepair,
  ...
  assert.equal(nearTargetSalvagedRepair.calls.length, 1);
  assert.equal(nearTargetSalvagedRepair.result.content, exactTraceRecovery240);
  assert.match(nearTargetSalvagedRepair.result.runtimeStats, /bounded-fresh-recovery=0/u);
  assert.doesNotMatch(
    JSON.stringify(nearTargetSalvagedRepair),
    new RegExp(`${nearTargetInitialSentinel}|${nearTargetRepairSentinel}`, "u"),
  );

  for (const proofFreeExecutionRequest of [
    { ...nearTargetAttestedRequest, contextAttestation: "not_required" },
    { ...nearTargetAttestedRequest, browserFinalContextExpectations: undefined },
  ]) {
    let proofDowngradeCalls = 0;
    await assert.rejects(
      () => executeBrowserBoundedQualityPasses({
        ...
        decision,
        executionRequest: proofFreeExecutionRequest,
        initialResult: nearTargetInitialResult,
        eligibility,
        performancePolicy,
        requiredGenerativeExecutor: "webllm-worker",
        deferTraditionalChineseNormalization: true,
    ...
    assert.equal(proofDowngradeCalls, 1);
  }

  const nearTargetRawBudgetRecovery = `${uniqueHan(321, 0x7600)}${"Z".repeat(320)}`;
  assert.equal(
    assessBrowserProseCompletion(nearTargetRawBudgetRecovery).rawBudgetExceeded,
    true,
  );
  for (const [recoveryContent, recoveryFinishReason, expectedReason] of [
    [exactHanPrefix(acceptedProse.repeat(2), 134), "stop", "QUALITY_LENGTHCOMPLIANCE_LOW"],
    [exactTraceRecovery240, "length", "QUALITY_OUTPUT_TRUNCATED"],
    [`<|im_end|>${exactTraceRecovery240}`, "stop", "QUALITY_OUTPUT_CONTROL_TOKEN"],
    [nearTargetRawBudgetRecovery, "stop", "QUALITY_OUTPUT_TRUNCATED"],
    [editorialRecovery, "stop", "QUALITY_TASK_FORM_MISMATCH"],
  ]) {
    let failedRecoveryCalls = 0;
    await assert.rejects(
      () => executeBrowserBoundedQualityPasses({
        request,
        decision,
        executionRequest: nearTargetAttestedRequest,
        initialResult: nearTargetInitialResult,
        eligibility,
        performancePolicy,
        requiredGenerativeExecutor: "webllm-worker",
        ...
        runPass: async (passRequest) => {
          ...
          assert.equal(failedRecoveryCalls, 2, "fresh recovery must remain final");
          assert.equal(
            passRequest.requestId,
            `${request.requestId}:bounded-fresh-recovery`,
          );
      ...
      (error) => {
        ...
        return error.code === "BROWSER_AI_QUALITY_INSUFFICIENT"
          ...
          && closedAgentBrowserRuntimeEvidence(error).length === 3
          && error.canonicalMutationCount === 0
          && !serializedError.includes(nearTargetInitialSentinel)
          && !serializedError.includes(nearTargetRepairSentinel)
          && nearTargetRejectedDigests.every(
            (digest) => !serializedError.includes(digest),
          );
      },
    );
    assert.equal(
      failedRecoveryCalls,
      2,
      "failed near-target recovery must not run a fourth pass",
    );
  }

  // Match the safe 8812 Fresh topology with constructed evidence only: a
  // 28-Han normal-EOS initial draft and a dense 508-Han normal-EOS repair.
  // Both are discarded before one final standalone, attested grammar recovery.
  const degenerateOversizedInitialSentinel = "\u2603\u2604\u2605";
  const degenerateOversizedRepairSentinel = "\u2606\u2607\u2608\u2609";
  const degenerateOversizedInitial28 = `${uniqueHan(
    28,
    0x7200,
  )}${degenerateOversizedInitialSentinel}`;
  const degenerateOversizedRepairBase = `${uniqueHan(
    508,
    0x7400,
  )}${degenerateOversizedRepairSentinel}`;
  assert.equal(degenerateOversizedInitial28.length, 31);
  assert.ok(degenerateOversizedRepairBase.length <= 592);
  const degenerateOversizedRepair508 = `${degenerateOversizedRepairBase}${
    "R".repeat(592 - degenerateOversizedRepairBase.length)
  }`;
  const degenerateOversizedInitialAssessment = assessBrowserProseCompletion(
    degenerateOversizedInitial28,
  );
  const degenerateOversizedRepairAssessment = assessBrowserProseCompletion(
    degenerateOversizedRepair508,
  );
  assert.deepEqual({
    characters: degenerateOversizedInitial28.length,
    han: degenerateOversizedInitialAssessment.observedHanCharacters,
    estimatedTokens:
      degenerateOversizedInitialAssessment.observedEstimatedTokens,
    codePoints: degenerateOversizedInitialAssessment.observedCodePoints,
    failureCode: degenerateOversizedInitialAssessment.failureCode,
    rawBudgetExceeded: degenerateOversizedInitialAssessment.rawBudgetExceeded,
    selectedHanCharacters:
      degenerateOversizedInitialAssessment.selectedHanCharacters,
    content: degenerateOversizedInitialAssessment.content,
    salvageableContent: degenerateOversizedInitialAssessment.salvageableContent,
  }, {
    characters: 31,
    han: 28,
    estimatedTokens: 32,
  ...
  assert.deepEqual({
    characters: degenerateOversizedRepair508.length,
    han: degenerateOversizedRepairAssessment.observedHanCharacters,
    estimatedTokens: degenerateOversizedRepairAssessment.observedEstimatedTokens,
    codePoints: degenerateOversizedRepairAssessment.observedCodePoints,
    failureCode: degenerateOversizedRepairAssessment.failureCode,
    rawBudgetExceeded: degenerateOversizedRepairAssessment.rawBudgetExceeded,
    selectedHanCharacters:
      degenerateOversizedRepairAssessment.selectedHanCharacters,
    content: degenerateOversizedRepairAssessment.content,
    salvageableContent: degenerateOversizedRepairAssessment.salvageableContent,
  }, {
    characters: 592,
    han: 508,
    estimatedTokens: 572,
  ...
  const degenerateOversizedOuterRequestId =
    "browser-degenerate-oversized-stop-outer";
  const degenerateOversizedAttestedRequest = {
    ...request,
    contextAttestation: "required",
    browserFinalContextOuterRequestId: degenerateOversizedOuterRequestId,
    browserFinalContextOuterTaskType: request.taskType,
    browserFinalContextOuterQualityPhase: "draft",
    browserFinalContextExpectations: [],
  };
  const degenerateOversizedInvocationProof = async (
    invocationRequestId,
    innerStage,
    innerIndex,
  ) => createBrowserFinalModelContextInvocationProof({
    outerRequestId: degenerateOversizedOuterRequestId,
    invocationRequestId,
    outerTaskType: request.taskType,
    outerQualityPhase: "draft",
    innerStage,
    ...
    modelDigest: model.modelDigest,
    callOptionsDigest: await sha256Hex(
      `degenerate-oversized-stop:${innerStage}:${innerIndex}`,
    ),
    systemMessage: "bounded recovery proof system descriptor",
    userMessage: "bounded recovery proof user descriptor",
    expectations: [],
  ...
  const degenerateOversizedRejectedDigests = [
    await sha256Hex(degenerateOversizedInitial28),
    await sha256Hex(degenerateOversizedRepair508),
  ];
  const degenerateOversizedInitialResult = {
    ...result(degenerateOversizedInitial28, "stop"),
    completionTokens: 23,
    rawOutputCharacters: 31,
    normalizedOutputCharacters: undefined,
    browserModelContextInvocationProof:
      await degenerateOversizedInvocationProof(request.requestId, "initial", 0),
  };
  const degenerateOversizedRepairResult = {
    ...result(
      degenerateOversizedRepair508,
      "stop",
      `${request.requestId}:bounded-same-model-repair`,
  ...
  const degenerateOversizedRecovery = await execute(
    degenerateOversizedInitialResult,
    [
      degenerateOversizedRepairResult,
      async (recoveryRequest, options) => {
        assertBoundedFreshRecoveryRequest(recoveryRequest, options);
        assert.equal(
          recoveryRequest.input,
        ...
        for (const rejectedValue of [
          ...
          degenerateOversizedInitialSentinel,
          degenerateOversizedRepairSentinel,
          ...degenerateOversizedRejectedDigests,
        ]) {
          assert.equal(serializedRecoveryInput.includes(rejectedValue), false);
        }
        return {
  ...
  assert.deepEqual(
    degenerateOversizedRecovery.calls.map((call) => call.request.requestId),
    [
      `${request.requestId}:bounded-same-model-repair`,
      `${request.requestId}:bounded-fresh-recovery`,
    ],
  ...
  assert.deepEqual(
    degenerateOversizedRecovery.browserRuntimeEvidence.map((entry) => [
      entry.stage,
      entry.finishReason,
      entry.completionTokens,
      entry.rawOutputCharacters,
    ...
    [
      ["initial", "stop", 23, 31, 28],
      ["repair", "stop", 341, 592, 508],
      ["recovery", "stop", 252, exactTraceRecovery240.length, 240],
    ],
  );
  assert.equal(degenerateOversizedRecovery.result.content, exactTraceRecovery240);
  assert.equal(degenerateOversizedRecovery.quality.decision, "pass");
  assert.equal(degenerateOversizedRecovery.result.externalRequest, false);
  assert.equal(degenerateOversizedRecovery.result.dataLeavesDevice, false);
  assert.ok(
    await verifyBrowserFinalModelContextAttestation(
      degenerateOversizedRecovery.result.finalModelContextAttestation,
    ),
  );
  assert.equal(
    degenerateOversizedRecovery.result
      .finalModelContextAttestation.acceptedDisposition,
    "standalone",
  );
  assert.equal(
    degenerateOversizedRecovery.result.finalModelContextAttestation.acceptedStage,
    "recovery",
  );
  assert.deepEqual(
    degenerateOversizedRecovery.result.finalModelContextAttestation.executedStages,
    ["initial", "repair", "recovery"],
  );
  assert.deepEqual(
    degenerateOversizedRecovery.result
  ...
  assert.match(
    degenerateOversizedRecovery.result.runtimeStats,
    /bounded-prose-extension=0/u,
  );
  assert.match(
    degenerateOversizedRecovery.result.runtimeStats,
  ...
  const serializedDegenerateOversizedRecovery = JSON.stringify(
    degenerateOversizedRecovery,
  );
  for (const rejectedValue of [
    degenerateOversizedInitial28,
    degenerateOversizedRepair508,
    ...
    assert.equal(serializedDegenerateOversizedRecovery.includes(rejectedValue), false);
  }
  await assertAuthoritativeSelectedResult({
    selectedExecution: degenerateOversizedRecovery,
    rawGeneration: `${degenerateOversizedInitial28}\n${degenerateOversizedRepair508}`,
    rejectedGenerations: [
      degenerateOversizedInitial28,
      degenerateOversizedRepair508,
    ],
    discardedSentinel: `${degenerateOversizedInitialSentinel}|${
      degenerateOversizedRepairSentinel
    }`,
    taskId: "browser-degenerate-oversized-stop-recovery-candidate",
  });

  const degenerateOversizedSalvagePrefix = `${uniqueHan(240, 0x7800)}\u3002`;
  const degenerateOversizedSalvageBase = `${
    degenerateOversizedSalvagePrefix
  }${uniqueHan(268, 0x7a00)}${degenerateOversizedRepairSentinel}`;
  assert.ok(degenerateOversizedSalvageBase.length <= 592);
  const degenerateOversizedSalvageRepair = `${
    degenerateOversizedSalvageBase
  }${"S".repeat(592 - degenerateOversizedSalvageBase.length)}`;
  const degenerateOversizedSalvageAssessment = assessBrowserProseCompletion(
    degenerateOversizedSalvageRepair,
  );
  assert.deepEqual({
    han: degenerateOversizedSalvageAssessment.observedHanCharacters,
    estimatedTokens:
      degenerateOversizedSalvageAssessment.observedEstimatedTokens,
    codePoints: degenerateOversizedSalvageAssessment.observedCodePoints,
    selectedHanCharacters:
      degenerateOversizedSalvageAssessment.selectedHanCharacters,
    selectedEstimatedTokens:
      degenerateOversizedSalvageAssessment.selectedEstimatedTokens,
    selectedCodePoints: degenerateOversizedSalvageAssessment.selectedCodePoints,
    salvageableContent:
      degenerateOversizedSalvageAssessment.salvageableContent,
  }, {
    han: 508,
    estimatedTokens: 572,
    codePoints: 592,
    ...
    selectedEstimatedTokens: 260,
    selectedCodePoints: 241,
    salvageableContent: degenerateOversizedSalvagePrefix,
  });
  const degenerateOversizedSalvageDigest = await sha256Hex(
    degenerateOversizedSalvageRepair,
  );
  const degenerateOversizedSalvageRecovery = await execute(
    degenerateOversizedInitialResult,
    [
      {
        ...result(
      ...
      async (recoveryRequest, options) => {
        ...
        for (const rejectedValue of [
          ...
          degenerateOversizedInitialSentinel,
          degenerateOversizedRepairSentinel,
          degenerateOversizedRejectedDigests[0],
          degenerateOversizedSalvageDigest,
        ]) {
          assert.equal(serializedRecoveryInput.includes(rejectedValue), false);
        }
        return {
  ...
  assert.equal(degenerateOversizedSalvageRecovery.calls.length, 2);
  assert.equal(
    degenerateOversizedSalvageRecovery.result.content,
    exactTraceRecovery240,
  );
  assert.notEqual(
    degenerateOversizedSalvageRecovery.result.content,
  ...
  assert.deepEqual(
    degenerateOversizedSalvageRecovery.result
      .finalModelContextAttestation.contributingCalls.map((call) => call.innerStage),
    ["recovery"],
  );
  const serializedDegenerateOversizedSalvageRecovery = JSON.stringify(
    degenerateOversizedSalvageRecovery,
  );
  for (const rejectedValue of [
    degenerateOversizedInitial28,
    degenerateOversizedSalvageRepair,
    ...
    assert.equal(
      serializedDegenerateOversizedSalvageRecovery.includes(rejectedValue),
      false,
    );
  }
  await assertAuthoritativeSelectedResult({
    selectedExecution: degenerateOversizedSalvageRecovery,
    rawGeneration: `${degenerateOversizedInitial28}\n${
      degenerateOversizedSalvageRepair
    }`,
    rejectedGenerations: [
    ...
    taskId: "browser-degenerate-oversized-stop-salvage-recovery-candidate",
  });

  for (const proofFreeExecutionRequest of [
    { ...degenerateOversizedAttestedRequest, contextAttestation: "not_required" },
    {
      ...degenerateOversizedAttestedRequest,
      browserFinalContextExpectations: undefined,
    },
    ...
    await assert.rejects(
      () => executeBrowserBoundedQualityPasses({
        ...
        decision,
        executionRequest: proofFreeExecutionRequest,
        initialResult: degenerateOversizedInitialResult,
        eligibility,
        performancePolicy,
        requiredGenerativeExecutor: "webllm-worker",
        deferTraditionalChineseNormalization: true,
        runPass: async (passRequest) => {
          ...
          return degenerateOversizedRepairResult;
        },
      }),
      (error) => error.code === "BROWSER_AI_QUALITY_INSUFFICIENT"
        && error.qualityReasonCodes?.includes("QUALITY_OUTPUT_TRUNCATED")
  ...
  for (const [recoveryContent, recoveryFinishReason, expectedReason] of [
    ...
    await assert.rejects(
      () => executeBrowserBoundedQualityPasses({
        request,
        decision,
        executionRequest: degenerateOversizedAttestedRequest,
        initialResult: degenerateOversizedInitialResult,
        eligibility,
        performancePolicy,
        requiredGenerativeExecutor: "webllm-worker",
      ...
      (error) => {
        ...
        return error.code === "BROWSER_AI_QUALITY_INSUFFICIENT"
          ...
          && closedAgentBrowserRuntimeEvidence(error).length === 3
          && error.canonicalMutationCount === 0
          && !serializedError.includes(degenerateOversizedInitialSentinel)
          && !serializedError.includes(degenerateOversizedRepairSentinel)
          && degenerateOversizedRejectedDigests.every(
            (digest) => !serializedError.includes(digest),
          );
      },
    );
