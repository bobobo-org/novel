...
const expectedTag = "novel-ai-p24b-conversation-first-studio-rc6.2";
const expectedRevision = "rc6.2";
const expectedName = "P2.4B Conversation-First Novel Project GPT RC6.2";
const expectedConsumerRelease = "p2.4b-conversation-first-studio-rc6.2";
