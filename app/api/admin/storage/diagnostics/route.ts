...
export async function GET(req: Request) {
  ...
  return NextResponse.json({
    ...
    extractionAtomicRpcVersion: "p0_l0a2e2_rollback_fixture_contract_014",
    ...
    extractionConcurrencyStatus: "partial",
    extractionConcurrencyPassCount: 0,
    ...
    hashParityStatus: "not_evaluated",
    atomicRpcP50: null,
    atomicRpcP95: null,
