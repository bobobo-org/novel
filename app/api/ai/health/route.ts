...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    indexedDbReader: "partial",
    indexedDbBackups: "partial",
    indexedDbLegacyMigration: "ready_source_retained",
    ...
    p2GrandIntegrationStatus: "partial_pending_production_verification",
