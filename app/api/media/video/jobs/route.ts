...
import { submitVideoGenerationJob } from "@/lib/novel-ai/media-extension/server/video-job-service";
import {
...
export async function POST(request: Request) {
  try {
    ...
    const job = await submitVideoGenerationJob(body, serverVideoJobDependencies());
