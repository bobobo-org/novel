...
export const BRIDGE_VERSION = "1.2.3-model-verification-lifecycle";
...
export const ERROR_CODES = Object.freeze([
  ...
  "LOCAL_REQUEST_TOO_LARGE", "LOCAL_PROVIDER_NOT_READY", "LOCAL_MODEL_INFERENCE_NOT_VERIFIED", "LOCAL_SECURITY_POLICY_VIOLATION", "LOCAL_RATE_LIMITED", "LOCAL_CONCURRENCY_LIMIT", "LOCAL_DUPLICATE_REQUEST", "LOCAL_REQUEST_IDENTITY_MISMATCH",
]);
