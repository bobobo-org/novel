...
export const H2W3_HEALTH = {
  ...
  ollamaLocalAiStatus: "available",
  localClosedRuntimeStatus: "ready",
  ...
  modelTrainingStatus: "started",
  loraTrainingStatus: "candidate_ready",
  qloraTrainingStatus: "hardware_blocked_no_cuda",
  adapterTrainingStatus: "candidate_ready_not_activated",
