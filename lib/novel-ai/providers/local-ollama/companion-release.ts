export const LOCAL_AI_COMPANION_RELEASE = {
  ...
  version: "1.4.6",
  filename: "novel-local-ai-companion-setup-v1.4.6.cmd",
  downloadPath: "/downloads/novel-local-ai-companion-setup-v1.4.6.cmd",
  checksumPath: "/downloads/novel-local-ai-companion-setup-v1.4.6.sha256",
  sha256: "439B153B531169BF1B51BC4AE012F01FC23D577A784AAB9DFC7AB51F0F9AF6ED",
  installScriptPath: "/downloads/novel-local-ai-companion-install-v1.4.6.ps1",
  installScriptSha256: "BFE21B68D2316002B6CFF10960E2B49B7AC3B8C3F9C6534A33C9DBAD44C97011",
  archiveFilename: "novel-local-ai-companion-v1.4.6.zip",
  archiveDownloadPath: "/downloads/novel-local-ai-companion-v1.4.6.zip",
  archiveChecksumPath: "/downloads/novel-local-ai-companion-v1.4.6.sha256",
  archiveSha256: "8D167C209E9F69DCC107F16FF6A816872BBE5F8F04ED3B5131C269CADEF2BDBF",
  installer: true,
  windowsLogonAutostart: true,
  signed: false,
  minimumNodeMajor: 22,
  minimumBridgeVersion: "1.2.0",
  recommendedBridgeVersion: "1.2.3",
