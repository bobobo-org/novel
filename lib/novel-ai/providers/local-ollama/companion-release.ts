export const LOCAL_AI_COMPANION_RELEASE = {
  ...
  version: "1.4.3",
  filename: "novel-local-ai-companion-v1.4.3.zip",
  downloadPath: "/downloads/novel-local-ai-companion-v1.4.3.zip",
  sha256: "4FB76104409D70B7D931F3662CDD57380FEBE08AC1B42916C6896EAC3F5A0549",
  signed: false,
  minimumNodeMajor: 22,
