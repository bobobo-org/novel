export const LOCAL_AI_COMPANION_RELEASE = {
  ...
  version: "1.4.0",
  filename: "novel-local-ai-companion-v1.4.0.zip",
  downloadPath: "/downloads/novel-local-ai-companion-v1.4.0.zip",
  sha256: "89868387A5572A2127703C1143AD4C41D6CD8BF2511938048400F73EC8F9E242",
  signed: false,
  minimumNodeMajor: 22,
