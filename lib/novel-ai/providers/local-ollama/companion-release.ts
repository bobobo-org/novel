export const LOCAL_AI_COMPANION_RELEASE = {
  ...
  version: "1.4.4",
  filename: "novel-local-ai-companion-setup-v1.4.4.cmd",
  downloadPath: "/downloads/novel-local-ai-companion-setup-v1.4.4.cmd",
  checksumPath: "/downloads/novel-local-ai-companion-setup-v1.4.4.sha256",
  sha256: "2A21B9A0CCB6261B19DAF17E9A8907AB793187609328995B0D3D7850C5E4FA90",
  installScriptPath: "/downloads/novel-local-ai-companion-install-v1.4.4.ps1",
  installScriptSha256: "D54876BB8B55ABEAD8BEB269C82F8356B3250B0C58A3271A0C8C9B55ED9AB025",
  archiveFilename: "novel-local-ai-companion-v1.4.4.zip",
  archiveDownloadPath: "/downloads/novel-local-ai-companion-v1.4.4.zip",
  archiveChecksumPath: "/downloads/novel-local-ai-companion-v1.4.4.sha256",
  archiveSha256: "C130C5D9246339065414BD36709313888FA091A5DB09CC06739B0866F49390D7",
  installer: true,
  windowsLogonAutostart: true,
  signed: false,
  minimumNodeMajor: 22,
  minimumBridgeVersion: "1.2.0",
  recommendedBridgeVersion: "1.2.2",
