...
export type PlatformProviderSnapshot = { id: PlatformProviderId; status: PlatformProviderStatus; capabilities: PlatformProviderCapability[]; modelId: string | null; maxContext: number; local: boolean; requiresInternet: boolean; latencyMs?: number; taskTypes?: PlatformTaskType[]; detail?: string };
