...
export type AcceptChoiceConversationApprovalInput = {
  operationId: string;
...
export type ApproveConversationArtifactTransactionInput = {
  operationId: string;
  idempotencyKey: string;
  projectId: string;
  sessionId: string;
...
export type ApproveConversationArtifactTransactionResult = {
  ...
  approvalTransaction: ConversationApprovalTransaction;
};
