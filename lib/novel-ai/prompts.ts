...
export const PROMPT_VERSION = "story-analyzer-v3";
...
11. analysisEvidence 至少列出 2 項你使用的上下文證據。
12. analysisScores 必須以 1 到 10 分評估：劇情推進、人物一致、新意、讀者鉤子、情感回收、風險清楚、證據使用。
13. qualityGate 必須反映選項是否重複、是否違反禁改、是否太空泛。
14. 不得輸出 API key、token、密碼或敏感連線資訊。`;
...
輸出格式：
{
  ...
  "forbiddenActions": [],
  "analysisEvidence": [
    {"sourceType":"主角設定","sourceLabel":"","reason":""}
  ],
