...
export const CAPABILITY_TRUTH_MATRIX: CapabilityTruthRecord[] = [
  ...
  { id: "visualCharacterBible", status: "verified", evidence: ["100-entry portrait catalog uniqueness test", "local PNG/JPEG/WebP upload pipeline", "approved visual traits in character AI and RPG context"], limitations: ["Bundled portraits are selectable visual references; they are not a live image-generation service"] },
