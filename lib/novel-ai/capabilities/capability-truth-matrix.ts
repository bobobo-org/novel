...
export const CAPABILITY_TRUTH_MATRIX: CapabilityTruthRecord[] = [
  ...
  { id: "visualCharacterBible", status: "verified", evidence: ["10,000-entry virtual portrait catalog uniqueness test (100 base artworks x 100 deterministic variants)", "local PNG/JPEG/WebP upload pipeline", "approved visual traits in character AI and RPG context"], limitations: ["Portrait variants are deterministic derivatives of bundled base artwork; they are not 10,000 separately hand-painted files or a live image-generation service"] },
