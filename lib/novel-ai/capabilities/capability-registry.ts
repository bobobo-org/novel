...
export const CAPABILITY_REGISTRY: CapabilityDefinition[] = [
  ...
  { id: "browser.aiRuntime", contractStatus: "ready", runtimeStatus: "ready", evidence: ["Chrome Summarizer capability probe, packaged extractive fallback and fixed-input inference proof"], limitations: ["The packaged fallback handles light extractive tasks; generative Browser AI remains device-dependent"] },
